...
- Первая идея — это декомпозиция.
  Это идея, что сложный проект дробиться на более простые модули, неймспейсы и типы.
  Дробление должно проводится так, чтобы каждая модуль имел единственную и понятную ответственность.
  Или так, чтобы отделить все самое важное от менее важного.
  Так же желательно, чтобы каждый модуль имел минимальное количество зависимостей.
  Имейте в виду, что при декомпозиции вы всегда должны думать о тех, кому возможно когда-нибудь придется разбираться в вашем проекте.
  Тем более, что возможно вам самим когда-то придется разбираться в вашем собственном проекте.
- Вторая идея — это Чистая Архитектура.
  Это идея, что проект декомпозируется на следующие модули: точка входа, презентация, приложение и предметная области.
...
**Проблема**
При разработке достаточно сложных проектов, количество файлов быстро вырастает до огромных количеств.
...
- Первая идея — все самое важное всегда должно быть у вас под рукой, а все второстепенное должен быть спрятано подальше.
  Давайте посмотрим на наш проект.
  Все самое важное я храню в папках Project и Project.Content.
  А весь мусор я спрятал в пакете Project.Infrastructure.
...
- Третья идея — избегайте больших вложенностей папок в проекте.
  ...
  К счастью можно подстветить специальные элементы в соответствующие цвета и таким образом сильно облегчить работу с проектом.
  Давайте посмотрим на наш проект.
  Я подсвечиваю пакеты в синие цвета, модули в красные, ассеты в желтые, а исходники в зеленные цвета.
  Благодоря этому я практически моментально нахожу все необходимые мне элементы в проекте.
