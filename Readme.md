...
- Вторая идея — это Domain-Driven Дизайн.
  ...
  То есть модуль предметной области является самым главным и ответственным только за бизнес задачи.
  А остальные модули являются техническими и нужны для обеспечения функционирования предметной области.
  В итоге получается, что проект разделяется на бизнес модули и технические модули.
  И технические модули никак не должны влиять на разработку бизнес модулей.
