...
Поэтому нужно организовывать проекты таким образом, чтобы было удобнее с ними работать.
...
- Вторая идея — это разделение проекта и контента.
  ...
  Это позволяет немного уменьшить вложенность папок.
...
Разобраться в таких проектах становится очень сложно.
Все становится еще хуже, когда над проектом работает много разработчиков с разными привычками и опытом.
Поэтому нужны правила разработки, которым будут следовать все разработчики проекта.
