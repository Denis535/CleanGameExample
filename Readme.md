...
- Первая идея — это Чистая Архитектура.
  Это идея, что все самое важное в проекте очищено от всего мусора.
  То есть проект состоит из первостепенных и второстепенных модулей.
...
- Вторая идея — это Domain-Driven Дизайн.
  Это идея, что предметная область является первостепенной.
  ...
  В итоге получается, что проект разделяется на бизнес часть и технические часть.
  И разработка бизнес части никак не должна зависить от технической части.
