...
namespace UnityEngine {
    ...
    public static class InitializationContext {
        ...
        internal static object GetArguments(Type componentType) {
            var type_context = typeof( Scope<> ).MakeGenericType( componentType );
        ...
        internal static object GetArguments<T>() where T : notnull, Component {
    ...
    public static class InitializationContextExtensions {
        ...
        public static object GetArguments(this Component component) {
            return InitializationContext.GetArguments( component.GetType() );
        }
        public static object GetArguments<T>(this T component) where T : notnull, Component {
            return InitializationContext.GetArguments( component.GetType() );
        }
