...
- Вторая идея — это разделение проекта и контента.
  ...
  Заметьте, что эти исходники и ассеты не перемешаны друг с другом, а содержатся в своих собственных папках.
  ...
  Но некоторый контент все же лучше хранить отдельно.
  Например, в папке Plugins я храню библиотеки, которые не имеют прямого отношения к нашему проекту.

**Вывод**
Благодаря этим идеям, проекты получаются достаточно простыми и удобными.
Весь основной контент всегда будет у вас под рукой, а все второстепенное спрятано подальше.
А команда разработчиков может сосредоточить свое внимание на основных деталях проекта и меньше думать о второстепенных.
...
**Проблема**
При разработке достаточно сложных проектов, проекты декомпозируется на множество модулей, неймспейсов и классов.
...
- Вторая парадигма — это Domain-Driven Дизайн.
  Это идея, что сердцем проекта являются сущности, выполняющие бизнес задачи нашего приложения, и в идеале, отражающие объекты реального мира.
...
**Вывод**
Благодаря этим идеям, проекты получается более логичными и однообразными.
...
А команда разработчиков может сосредоточить свое внимание на решении бизнес задач и меньше думать о технических проблемах.
Что в свою очередь повышает эффективность разработки и поддержки проекта.
