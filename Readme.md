...
- Второй совет — подсвечивайте элементы проекта в разные цвета.
  ...
  В итоге разработчики практически мгновенно могут находить в проекте необходимые им файлы.
...
- Третий совет — используйте панель меню для быстрого открытия нужных файлов.
  Давайте посмотрим на наш проект.
