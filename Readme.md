...
**Решение**
Для более качественной организации архитектуры проекта можно использовать следующие парадигмы:
- Первая парадигма — это Чистая Архитектура.
...
- Вторая парадигма — это Domain-Driven Дизайн.
  Это идея, что сердцем проекта являются сущности, выполняющие бизнес задачи приложения и отражающие объекты реального или виртуального мира.
  ...
  В итоге так же получается, что главный модуль предметной области становится максимально простым и чистым.
  А другие модули никак не должны влиять на нашу предметную область.
- Третья парадигма — это View-Driven UI.
...
- Четвертая парадигма — это State-Driven UI.
