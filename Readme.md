...
- GameBase и Game - это сущность игры.
  Эта сущность содержит всю необходимую информацию, состояния и правила игры.
  А так же содержит другие сущности, например: игроков, персонажей, лут и подобное.
...
- World - это сущность мира, которая предоставляет вам все статические объекты мира.
