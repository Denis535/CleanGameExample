...
**Решение**
Для лучшей организации структуры проекта я могу предложить следующие советы:
...
- Третья идея — избегайте больших иерархии папок в проекте.
  Вложенные папки усложняют работу с проектом так как всегда нужно тратить некоторое время, чтобы найти нужные файлы в глубинах проекта.
