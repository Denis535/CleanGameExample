    ...
    public class UIScreenEditor : UnityEngine.Framework.UI.UIScreenEditor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (!EditorApplication.isPlaying) {
                foreach (var method in typeof( VisualElementFactory_Main ).GetMethods( BindingFlags.Public | BindingFlags.Static )) {
                ...
                foreach (var method in typeof( VisualElementFactory_Game ).GetMethods( BindingFlags.Public | BindingFlags.Static )) {
                ...
                foreach (var method in typeof( VisualElementFactory_Common ).GetMethods( BindingFlags.Public | BindingFlags.Static )) {
