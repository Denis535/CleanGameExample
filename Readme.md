...
На этом примере я расскажу о лучших практиках организации архитектуры и структуры игрового проекта.
Я так же расскажу ваи о внутреннем устройстве примера и нескольких дополнительных пакетов.
А после просмотра вы получите доступ к репозиторию проекта и сможете использовать его как шаблон для ваших проектов.
Так же вы получите доступ к нескольким дополнительным пакетам, которые вы так же сможете использовать в ваших собственных проектах.
Заметьте, что эти знания будут вам полезны не только для работы с Unity, но и в других сферах программирования.
