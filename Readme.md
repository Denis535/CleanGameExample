...
**Решение**
Для лучшей организации архитектуры проекта я могу предложить следующие советы:
- Декомпозиция — это идея, что проект дробиться на более простые модули, неймспейсы и типы.
...
- Чистая архитектура — это идея, что проект декомпозируется на следующие модули: точка входа, презентация, приложение и предметная области.
...
- Domain-driven дизайн — это идея, что модули предметной области являются самыми главными в проекте.
...
- Инверсия зависимостей — это идея, что модули предметной области не должны иметь зависимостей на технические модули.
...
- Рассматривайте ваши проекты как множество рабочих пространств.
  Старайтесь организовать ваши проекты таким образом, чтобы при выполнении какой-либо задачи, все необходимые файлы находились рядом друг с другом, а все остальные файлы находились отдельно.
...
- Подсвечивайте специальные элементы проекта в соответствующие им цвета.
  ...
  Благодаря такому подходу, я практически мгновенно нахожу в проекте все необходимые мне элементы.
  В теории, можно было бы сделать еще лучше, но к сожалению Unity предоставляет мало возможностей по кастомизации окна проекта.
