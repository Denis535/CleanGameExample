...
<!--########## ########## ########## ########## ##########-->
# Обзор
В этом видео курсе мы подробно рассмотрим мой пример шутера от третьего лица.
В этом проекте я постарался реализовать все свои лучшие идеи и наработки.
И теперь я хочу рассказать вам о лучших практиках, накопленных за годы работы в игровой индустрии.
...
Эти знания будут вам полезны не только для работы с Unity, но и в любых других сферах программирования.

В этом курсе:
- Мы подробно рассмотрим наш пример шутера и несколько дополнительных пакетов.
...
- Мы рассмотрим как расширить редактор Unity, чтобы повысить удобство и продуктивность рабочего процесса.
...
Я расскажу обо всех внутренних деталях данного проекта и нескольких дополнительных пакетов.
...
- Первый совет — рассматривайте проект как множество рабочих пространств.
  ...
  А все прочие файлы находятся отдельно и не мешаются.
...
- Второй совет — подсвечивайте элементы проекта в разные цвета.
  ...
  В итоге разработчики практически мгновенно находят в проекте все необходимые им файлы.
...
- Третий совет — используйте команды панели меню для быстрого открытия нужных файлов.
  Давайте посмотрим на наш проект.
  Я создал несколько команд, которые выполняют некоторые полезные задачи, в том числе открывают все сцены и некоторые другие файлы.
  В итоге, разработчики практически мгновенно могут открывать нужные им файл и выполнить некоторые задачи.
