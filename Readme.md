...
- Модульная архитектура — это идея, что проект декомпозируется на более простые модули.
...
- Чистая архитектура — это идея, что проект декомпозируется на такие модули: точка входа, презентация, приложение и предметная области.
...
- Подсвечивайте специальные элементы проекта в соответствующие им цвета.
  ...
  Замечу, что в теории, можно было бы сделать еще лучше, но к сожалению Unity предоставляет мало возможностей по кастомизации окна проекта.
