...
- Первая идея — это декомпозиция проекта.
  Это идея, что сложный проект разделяется на более простые модули, неймспейсы и типы.
  Заметьте, что проект можно декомпозировать или по назначению кода или по уровню абстракции кода.
...
- Первая идея — это Чистая Архитектура.
  Это идея, что проект состоит из конкретных модулей, причем каждый модуль должен иметь одну ответственность и определенные зависимости.
  То есть проект может состоять из точки входа, презентации, приложения, предметной области и модуля инфраструктуры.
  Или проект может состоять просто из первостепенных и второстепенных модулей.
  В итоге получается, что все проекты становятся логичными и похожими друг на друга.
